...
This guide builds on the [`Linux 101 Guide`](linux_101.md) to introduce version control through basic command-line activities. It assumes `git` is installed and that you can use a terminal.
