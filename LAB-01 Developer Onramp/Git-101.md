...
This guide introduces version control through basic command-line activities. It builds on the [`Linux-101`](Linux-101.md) guide. It assumes `git` is installed and that you can use a terminal.
...
> [!TIP]
> Please refer to the official [Git installation guide](https://git-scm.com/install) for detailed installation instructions.
...
- [Git CLI cheat sheet](https://training.github.com/downloads/github-git-cheat-sheet)
